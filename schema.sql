...
CREATE TABLE bus_complaints (
  ...
  relationship_text VARCHAR(150) NULL,
  complaint_text LONGTEXT NULL,
  complaint_main_type VARCHAR(80) NOT NULL DEFAULT 'administrative complain',
  ...
  communication_type VARCHAR(120) NULL,
  responsible_name VARCHAR(150) NULL,
  students_involved_count INT NOT NULL DEFAULT 0,
  FOREIGN KEY (student_id) REFERENCES students(id),
  FOREIGN KEY (bus_id) REFERENCES buses(id)
);
